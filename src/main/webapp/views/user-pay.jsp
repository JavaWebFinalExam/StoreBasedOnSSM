                            ...
                            <li class="td td-item">
                                <div class="item-pic">
                                    <a href="#" class="J_MakePoint">
                                        <img width="80px" height="80px" src="<%=basePath%>${productimage.path}" class="itempic J_ItemImg"></a>
                                </div>
                                <div class="item-info">
        ...
        <div class="order-extra">
            <div class="order-user-info">
                <div id="holyshit257" class="memo">
                    <label>买家留言：</label>
                    <input required id="usermessage" type="text" title="选填,对本次交易的说明（建议填写已经和卖家达成一致的说明）" placeholder="选填,建议填写和卖家达成一致的说明" class="memo-input J_MakePoint c2c-text-default memo-close">
                    ...
                    <div id="holyshit268" class="pay-address">
                        ...
                        <p class="buy-footer-address">
                            ...
                            <span class="buy--address-detail">
								   <span class="province"><input required id="addressis"  type="text" title="请填写收货地址" placeholder="请填写收货地址" class="memo-input J_MakePoint c2c-text-default memo-close" style="width: 70px"></span>
												</span>
                            </span>
                        </p>
                        <p class="buy-footer-address">
                            ...
                            <span class="buy-address-detail">
												<input required id="receiveris" type="text" title="必填，请填写您的姓名" placeholder="必填，请填写您的姓名" class="memo-input J_MakePoint c2c-text-default memo-close" style="width: 70px">
												</span>
                        </p>
                        <p class="buy-footer-address">
                            <span class="buy-line-title">电话号码：</span>
                            <span class="buy-address-detail">
												<input required id="mobile" type="text" title="必填，请填写收货人的电话号码" placeholder="必填，请填写收货人的电话号码" class="memo-input J_MakePoint c2c-text-default memo-close" style="width: 70px">
												</span>
                        </p>
                    </div>
                </div>
...
<script type="text/javascript">
    $("#successful").click(function () {
        ...
        if (userMessage!=""&&mobile!=""&&receiver!=""&&address!="") {
            var json_data = {
